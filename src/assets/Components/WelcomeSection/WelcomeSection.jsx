                    ...
                    <div>
                        <div className="w-full">
                            <div className="relative lg:w-[270px] w-[200px] ">
                                <img className="lg:w-[150px] w-[140px] absolute top-5 -right-12 rounded-lg shadow-2xl shadow-gray-900" src="https://i.ibb.co/L9pzZx0/happy-friends-with-birthday-cake-1.jpg" alt="" />
                                <img className="lg:w-[160px] w-[140px] absolute top-10 -left-10 rounded-lg shadow-2xl shadow-gray-900" src="https://i.ibb.co/NTzKqfd/al-elmes-ULHx-Wq8reao-unsplash.jpg" alt="" />
                                <img className="rounded-lg shadow-lg" src="https://i.ibb.co/gPwxXG5/karsten-winegeart-o8tnv-Y9i-B3-E-unsplash.jpg" alt="" />
                                <img className="lg:w-[150px] w-[130px] absolute -bottom-10 -right-12 rounded-lg shadow-2xl shadow-gray-900" src="https://i.ibb.co/YLgm9MF/ivan-kazlouskij-lplt-N2-Wd-I2-Q-unsplash.jpg" alt="" />
                                <img className="lg:w-[160px] w-[130px] absolute -bottom-10 -left-10 rounded-lg shadow-2xl shadow-gray-900" src="https://i.ibb.co/tKm07VN/alvaro-cvg-m-W8-IZd-X7n8-E-unsplash.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
