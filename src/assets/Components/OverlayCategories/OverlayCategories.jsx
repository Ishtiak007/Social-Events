...
const OverlayCategories = () => {
    return (
        <div className='bg-slate-100 p-5 rounded-xl'>
            ...
            <div>
                <div className="md:flex justify-evenly" data-aos="fade-right">
                    <div className="relative lg:w-[350px] md:w-[200px]" data-aos="fade-up"
                ...
                <div className='md:flex justify-evenly mt-6' data-aos="fade-left">
                    <div className="relative lg:w-[350px] md:w-[200px]" data-aos="fade-up"
                        data-aos-duration="3000">
